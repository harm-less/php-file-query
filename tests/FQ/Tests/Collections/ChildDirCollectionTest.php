...
class ChildDirCollectionTest extends AbstractDirCollectionTest {
	...
	public function testAddDirIsDisabled() {
		$this->setExpectedException('FQ\Exceptions\FileException', 'Use addChildDir() to add directories');
		$collection = $this->dirCollection();
